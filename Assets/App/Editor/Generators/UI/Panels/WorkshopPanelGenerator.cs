...
{
    public static class WorkshopPanelGenerator
    {
        ...
        [MenuItem("MoodColor/Generate/UI Panels/Personal Area/Workshop Panel")]
        public static void CreateWorkshopPanelPrefab()
        {
            LoadResources();
            ...
            // TODO: Создать специфичный контент для WorkshopPanel
